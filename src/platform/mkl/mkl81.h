...
#define TRNG_REG32(_a) REG32(0x40025000 + (_a))
#define TRNG0_MCTL TRNG_REG32(0x0)
#define TRNG0_SCMISC TRNG_REG32(0x4)
#define TRNG0_PKRRNG TRNG_REG32(0x8)

#define TRNG0_PKRMAX TRNG_REG32(0xC)
#define TRNG0_PKRSQ TRNG_REG32(0xC)
#define TRNG0_SDCTL TRNG_REG32(0x10)

#define TRNG0_SBLIM TRNG_REG32(0x14)
#define TRNG0_TOTSAM TRNG_REG32(0x14)

#define TRNG0_FRQMIN TRNG_REG32(0x18)

#define TRNG0_FRQMAX TRNG_REG32(0x1C)
#define TRNG0_FRQCNT TRNG_REG32(0x1C)

#define TRNG0_SCMC TRNG_REG32(0x20)
#define TRNG0_SCML TRNG_REG32(0x20)

#define TRNG0_SCR1L TRNG_REG32(0x24)
#define TRNG0_SCR1C TRNG_REG32(0x24)

#define TRNG0_SCR2L TRNG_REG32(0x28)
#define TRNG0_SCR2C TRNG_REG32(0x28)

#define TRNG0_SCR3L TRNG_REG32(0x2C)
#define TRNG0_SCR3C TRNG_REG32(0x2C)

#define TRNG0_SCR4L TRNG_REG32(0x30)
#define TRNG0_SCR4C TRNG_REG32(0x30)

#define TRNG0_SCR5L TRNG_REG32(0x34)
#define TRNG0_SCR5C TRNG_REG32(0x34)

#define TRNG0_SCR6PL TRNG_REG32(0x38)
#define TRNG0_SCR6PC TRNG_REG32(0x38)

#define TRNG0_STATUS TRNG_REG32(0x3C)
#define TRNG0_ENT(_x) TRNG_REG32(0x40 + ((_x) * 4))
#define TRNG0_PKRCNT10 TRNG_REG32(0x80)
#define TRNG0_PKRCNT32 TRNG_REG32(0x84)
#define TRNG0_PKRCNT54 TRNG_REG32(0x88)
#define TRNG0_PKRCNT76 TRNG_REG32(0x8C)
#define TRNG0_PKRCNT98 TRNG_REG32(0x90)
#define TRNG0_PKRCNTBA TRNG_REG32(0x94)
#define TRNG0_PKRCNTDC TRNG_REG32(0x98)
#define TRNG0_PKRCNTFE TRNG_REG32(0x9C)
#define TRNG0_SEC_CFG TRNG_REG32(0xA0)
#define TRNG0_INT_CTRL TRNG_REG32(0xA4)
#define TRNG0_INT_MASK TRNG_REG32(0xA8)
#define TRNG0_INT_STATUS TRNG_REG32(0xAC)
#define TRNG0_VID1 TRNG_REG32(0xF0)
#define TRNG0_VID2 TRNG_REG32(0xF4)

/* TRNG0_MCTL */

#define TRNG0_MCTL_PRGM BIT(16) 
#define TRNG0_MCTL_TSTOP_OK BIT(13)
#define TRNG0_MCTL_ERR BIT(12) 
#define TRNG0_MCTL_TST_OUT BIT(11) 
#define TRNG0_MCTL_ENT_VAL BIT(10)
#define TRNG0_MCTL_FCT_VAL BIT(9)
#define TRNG0_MCTL_FCT_FAIL BIT(8)
#define TRNG0_MCTL_FOR_SCLK BIT(7)
#define TRNG0_MCTL_RST_DEF BIT(6)
#define TRNG0_MCTL_TRNG_ACC BIT(5) 

#define TRNG0_MCTL_OSC_DIV_MASK GENMASK(3, 2)
#define TRNG0_MCTL_OSC_DIV(_x) FIELD_PREP(TRNG0_MCTL_OSC_DIV_MASK, _x)

#define TRNG0_MCTL_OSC_DIV_1 TRNG0_MCTL_OSC_DIV(0)
#define TRNG0_MCTL_OSC_DIV_2 TRNG0_MCTL_OSC_DIV(1)
#define TRNG0_MCTL_OSC_DIV_4 TRNG0_MCTL_OSC_DIV(2)
#define TRNG0_MCTL_OSC_DIV_8 TRNG0_MCTL_OSC_DIV(3)

#define TRNG0_MCTL_SAMP_MODE_MASK GENMASK(1, 0)
#define TRNG0_MCTL_SAMP_MODE(_x) FIELD_PREP(TRNG0_MCTL_SAMP_MODE_MASK, _x)


/* TRNG0_SMISC */

#define TRNG0_SMISC_RTY_CT_MASK GENMASK(19, 16)
#define TRNG0_SMISC_RTY_CT(_x) FIELD_PREP(TRNG0_SMISC_RTY_CT_MASK, _x)
#define TRNG0_SMISC_LRUN_MAX_MASK GENMASK(7, 0)
#define TRNG0_SMISC_LRUN_MAX(_x) FIELD_PREP(TRNG0_SMISC_LRUN_MAX_MASK, _x)

/* TRNG0_PKRRNG */

#define TRNG0_PKRRNG_PKR_RNG_MASK GENMASK(15, 0)
#define TRNG0_PKRRNG_PKR_RNG(_x) FIELD_PREP(TRNG0_PKRRNG_PKR_RNG_MASK, _x)

/* TRNG0_PKRMAX */

#define TRNG0_PKRMAX_PKR_MAX_MASK GENMASK(23, 0)
#define TRNG0_PKRMAX_PKR_MAX(_x) FIELD_PREP(TRNG0_PKRMAX_PKR_MAX_MASK, _x)

/* TRNG0_PKRSQ */

#define TRNG0_PKRSQ_PKR_SQ_MASK GENMASK(23, 0)
#define TRNG0_PKRSQ_PKR_SQ(_x) FIELD_PREP(TRNG0_PKRSQ_PKR_SQ_MASK, _x)

/* TRNG0_SDCTL */

#define TRNG0_SDCTL_ENT_DLY_MASK GENMASK(31, 16)
#define TRNG0_SDCTL_ENT_DLY(_x) FIELD_PREP(TRNG0_SDCTL_ENT_DLY_MASK, _x)
#define TRNG0_SDCTL_SAMP_SIZE_MASK GENMASK(15, 0)
#define TRNG0_SDCTL_SAMP_SIZE(_x) FIELD_PREP(TRNG0_SDCTL_SAMP_SIZE_MASK, _x)

/* TRNG0_SBLIM */

#define TRNG0_SBLIM_SB_LIM_MASK GENMASK(9, 0)
#define TRNG0_SBLIM_SB_LIM(_x) FIELD_PREP(TRNG0_SBLIM_SB_LIM_MASK, _x)

/* TRNG0_TOTSAM */

#define TRNG0_TOTSAM_TOT_SAM_MASK GENMASK(19, 0)
#define TRNG0_TOTSAM_TOT_SAM(_x) FIELD_PREP(TRNG0_TOTSAM_TOT_SAM_MASK, _x)

/* TRNG0_FRQMIN */

#define TRNG0_FRQMIN_FRQ_MIN_MASK GENMASK(21, 0)
#define TRNG0_FRQMIN_FRQ_MIN(_x) FIELD_PREP(TRNG0_FRQMIN_FRQ_MIN_MASK, _x)

/* TRNG0_FRQMAX */

#define TRNG0_FRQMAX_FRQ_MAX_MASK GENMASK(21, 0)
#define TRNG0_FRQMAX_FRQ_MAX(_x) FIELD_PREP(TRNG0_FRQMAX_FRQ_MAX_MASK, _x)

/* TRNG0_SCMC */

#define TRNG0_SCMC_MONO_CT_MASK GENMASK(15, 0)
#define TRNG0_SCMC_MONO_CT(_x) FIELD_PREP(TRNG0_SCMC_MONO_CT_MASK, _x)

/* TRNG0_SCML */

#define TRNG0_SCML_MONO_RNG_MASK GENMASK(31, 16)
#define TRNG0_SCML_MONO_RNG(_x) FIELD_PREP(TRNG0_SCML_MONO_RNG_MASK, _x)
#define TRNG0_SCML_MONO_MAX_MASK GENMASK(15, 0)
#define TRNG0_SCML_MONO_MAX(_x) FIELD_PREP(TRNG0_SCML_MONO_MAX_MASK, _x)

/* TRNG0_SCRnC */

#define TRNG0_SCRnC_Rn_1_CT_MASK GENMASK(30, 16)
#define TRNG0_SCRnC_Rn_1_CT(_x) FIELD_PREP(TRNG0_SCRnC_Rn_1_CT_MASK, _x)
#define TRNG0_SCRnC_Rn_0_CT_MASK GENMASK(14, 0)
#define TRNG0_SCRnC_Rn_0_CT(_x) FIELD_PREP(TRNG0_SCRnC_Rn_0_CT_MASK, _x)

/* TRNG0_SCRnL */

#define TRNG0_SCRnL_RUNn_RNG_MASK GENMASK(30, 16)
#define TRNG0_SCRnL_RUNn_RNG(_x) FIELD_PREP(TRNG0_SCRnL_RUNn_RNG_MASK, _x)
#define TRNG0_SCRnL_RUNn_MAX_MASK GENMASK(14, 0)
#define TRNG0_SCRnL_RUNn_MAX(_x) FIELD_PREP(TRNG0_SCRnL_RUNn_MAX_MASK, _x)

/* TRNG0_STATUS */

#define TRNG0_STATUS_RETRY_CT_MASK GENMASK(19, 16)
#define TRNG0_STATUS_RETRY_CT(_x) FIELD_PREP(TRNG0_STATUS_RETRY_CT_MASK, _x)
#define TRNG0_STATUS_TFMB BIT(15)
#define TRNG0_STATUS_TFP BIT(14)
#define TRNG0_STATUS_TFLR BIT(13)
#define TRNG0_STATUS_TFSB BIT(12)
#define TRNG0_STATUS_TF6PBR1 BIT(11)
#define TRNG0_STATUS_TF6PBR0 BIT(10)
#define TRNG0_STATUS_TF5BR1 BIT(9)
#define TRNG0_STATUS_TF5BR0 BIT(8)
#define TRNG0_STATUS_TF4BR1 BIT(7)
#define TRNG0_STATUS_TF4BR0 BIT(6)
#define TRNG0_STATUS_TF3BR1 BIT(5)
#define TRNG0_STATUS_TF3BR0 BIT(4)
#define TRNG0_STATUS_TF2BR1 BIT(3)
#define TRNG0_STATUS_TF2BR0 BIT(2)
#define TRNG0_STATUS_TF1BR1 BIT(1)
#define TRNG0_STATUS_TF1BR0 BIT(0)

/* TRNG0_PKRCNTxy */

#define TRNG0_PKRCNTxy_PKR_x_CNT_MASK GENMASK(31, 16)
#define TRNG0_PKRCNTxy_PKR_x_CNT(_x) FIELD_PREP(TRNG0_PKRCNTxy_PKR_x_CNT_MASK, _x)
#define TRNG0_PKRCNTxy_PKR_y_CNT_MASK GENMASK(15, 0)
#define TRNG0_PKRCNTxy_PKR_y_CNT(_x) FIELD_PREP(TRNG0_PKRCNTxy_PKR_y_CNT_MASK, _x)

/* TRNG0_SEC_CFG */

#define TRNG0_SEC_CFG_SK_VAL BIT(2)
#define TRNG0_SEC_CFG_NO_PRGM BIT(1)
#define TRNG0_SEC_CFG_SH0 BIT(0)

/* TRNG0_INT_CTRL */

#define TRNG0_INT_CTRL_FRQ_CT_FAIL BIT(2)
#define TRNG0_INT_CTRL_ENT_VAL BIT(1)
#define TRNG0_INT_CTRL_HW_ERR BIT(0)

/* TRNG0_INT_STATUS */

#define TRNG0_INT_STATUS_FRQ_CT_FAIL BIT(2)
#define TRNG0_INT_STATUS_ENT_VAL BIT(1)
#define TRNG0_INT_STATUS_HW_ERR BIT(0)

/* LTC */

#define LTC_REG32(_a)	REG32(0x40051000 + (_a))
#define LTC_REG8(_a)    REG8(0x40051000 + (_a))
#define LTC0_MD     LTC_REG32(0x0)
#define LTC0_MDPK   LTC_REG32(0x0)
#define LTC0_KS     LTC_REG32(0x8)
#define LTC0_DS     LTC_REG32(0x10)
#define LTC0_ICVS   LTC_REG32(0x18)
#define LTC0_COM    LTC_REG32(0x30)
#define LTC0_CTL    LTC_REG32(0x34)
#define LTC0_CW     LTC_REG32(0x40)
#define LTC0_STA LTC_REG32(0x48)
#define LTC0_ESTA LTC_REG32(0x4C)
#define LTC0_AADSZ LTC_REG32(0x58)
#define LTC0_IVSZ LTC_REG32(0x60)
#define LTC0_DPAMS LTC_REG32(0x68)
#define LTC0_PKASZ LTC_REG32(0x80)
#define LTC0_PKBSZ LTC_REG32(0x88)
#define LTC0_PKNSZ LTC_REG32(0x90)
#define LTC0_PKESZ LTC_REG32(0x98)
#define LTC0_CTX(_x) LTC_REG32(0x100 + ((_x) * 4))
#define LTC0_KEY     LTC_REG32(0x200)
#define LTC0_VID1    LTC_REG32(0x4F0)
#define LTC0_VID2    LTC_REG32(0x4F4)
#define LTC0_CHAVID  LTC_REG32(0x4F8)
...
#define LTC0_MD_ALG_MASK GENMASK(23, 16)
#define LTC0_MD_ALG(_x) FIELD_PREP(LTC0_MD_ALG_MASK, _x)

#define LTC0_MD_ALG_AES          LTC0_MD_ALG(0b0010000)
#define LTC0_MD_ALG_DES          LTC0_MD_ALG(0b0100000)
#define LTC0_MD_ALG_3DES         LTC0_MD_ALG(0b0100001)
#define LTC0_MD_ALG_MDHA_SHA_1   LTC0_MD_ALG(0b1000001)
#define LTC0_MD_ALG_MDHA_SHA_224 LTC0_MD_ALG(0b1000010)
#define LTC0_MD_ALG_MDHA_SHA_256 LTC0_MD_ALG(0b1000011)

#define LTC0_MD_AAI_MASK GENMASK(12, 4)
#define LTC0_MD_AAI(_x) FIELD_PREP(LTC0_MD_AAI_MASK, _x)

#define LTC0_MD_AS_MASK GENMASK(3, 2)
#define LTC0_MD_AS(_x) FIELD_PREP(LTC0_MD_AS_MASK, _x)

#define LTC0_MD_AS_UPDATE        LTC0_MD_AS(0)
#define LTC0_MD_AS_INIT          LTC0_MD_AS(1)
#define LTC0_MD_AS_FINALIZE      LTC0_MD_AS(2)
#define LTC0_MD_AS_INIT_FIN      LTC0_MD_AS(3)

#define LTC0_MD_ICV_TEST BIT(1)
#define LTC0_MD_ENC BIT(0)

/* LTC0_KS */

#define LTC0_KS_KS_MASK GENMASK(5, 0)
#define LTC0_KS_KS(_x) FIELD_PREP(LTC0_KS_KS_MASK, _x)

/* LTC0_DS */

#define LTC0_DS_DS_MASK GENMASK(11, 0)
#define LTC0_DS_DS(_x) FIELD_PREP(LTC0_DS_DS_MASK, _x)

/* LTC0_ICVS */

#define LTC0_ICVS_IVCS_MASK GENMASK(4, 0)
#define LTC0_ICVS_IVCS(_x) FIELD_PREP(LTC0_ICVS_IVCS_MASK, _x)

/* LTC0_COM */

#define LTC0_COM_MD BIT(7)
#define LTC0_COM_PK BIT(6)
#define LTC0_COM_DES BIT(2)
#define LTC0_COM_AES BIT(1)
#define LTC0_COM_ALL BIT(0)

/* LTC0_CTL */

#define LTC0_CTL_KAL BIT(31)
#define LTC0_CTL_COS BIT(23)
#define LTC0_CTL_CIS BIT(22)
#define LTC0_CTL_KOS BIT(21)
#define LTC0_CTL_KIS BIT(20)
#define LTC0_CTL_OFS BIT(17)
#define LTC0_CTL_IFS BIT(16)
#define LTC0_CTL_OFR BIT(13)
#define LTC0_CTL_OFE BIT(12)
#define LTC0_CTL_IFR BIT(9)
#define LTC0_CTL_IFE BIT(8)
#define LTC0_CTL_PDE BIT(4)
#define LTC0_CTL_IM BIT(0)

/* LTC0_CW */

#define LTC0_CW_CIF BIT(31)
#define LTC0_CW_COF BIT(30)
#define LTC0_CW_CPKE BIT(15)
#define LTC0_CW_CPKN BIT(14)
#define LTC0_CW_CPKB BIT(13)
#define LTC0_CW_CPKA BIT(12)
#define LTC0_CW_CKR BIT(6)
#define LTC0_CW_CCR BIT(5)
#define LTC0_CW_CICV BIT(3)
#define LTC0_CW_CDS BIT(2)
#define LTC0_CW_CM BIT(0)

/* LTC0_STA */

#define LTC0_STA_PKZ BIT(30)
#define LTC0_STA_PKO BIT(29)
#define LTC0_STA_PKP BIT(28)
#define LTC0_STA_DPARRN BIT(24)
#define LTC0_STA_EI BIT(20)
#define LTC0_STA_DI BIT(16)
#define LTC0_STA_MB BIT(7)
#define LTC0_STA_PB BIT(6)
#define LTC0_STA_DB BIT(2)
#define LTC0_STA_AB BIT(1)

/* LTC0_ESTA */

#define LTC0_ESTA_CL1_MASK GENMASK(11, 8)
#define LTC0_ESTA_CL1(_x) FIELD_PREP(LTC0_ESTA_CL1_MASK, _x)
#define LTC0_ESTA_ERRID1_MASK GENMASK(3, 0)
#define LTC0_ESTA_ERRID1(_x) FIELD_PREP(LTC0_ESTA_ERRID1_MASK, _x)

/* LTC0_AADSZ */

#define LTC0_AADSZ_AL BIT(31)
#define LTC0_AADSZ_AADSZ_MASK GENMASK(3, 0)
#define LTC0_AADSZ_AADSZ(_x) FIELD_PREP(LTC0_AADSZ_AADSZ_MASK, _x)

/* LTC0_IVSZ */

#define LTC0_IVSZ_IL BIT(31)
#define LTC0_IVSZ_IVSZ_MASK GENMASK(3, 0)
#define LTC0_IVSZ_IVSZ(_x) FIELD_PREP(LTC0_IVSZ_IVSZ_MASK, _x)

/* LTC0_PKASZ */

#define LTC0_PKASZ_PKASZ_MASK GENMASK(8, 0)
#define LTC0_PKASZ_PKASZ(_x) FIELD_PREP(LTC0_PKASZ_PKASZ_MASK, _x)

/* LTC0_PKBSZ */

#define LTC0_PKBSZ_PKBSZ_MASK GENMASK(8, 0)
#define LTC0_PKBSZ_PKBSZ(_x) FIELD_PREP(LTC0_PKBSZ_PKBSZ_MASK, _x)

/* LTC0_PKNSZ */

#define LTC0_PKNSZ_PKNSZ_MASK GENMASK(8, 0)
#define LTC0_PKNSZ_PKNSZ(_x) FIELD_PREP(LTC0_PKNSZ_PKNSZ_MASK, _x)

/* LTC0_PKESZ */

#define LTC0_PKESZ_PKESZ_MASK GENMASK(8, 0)
#define LTC0_PKESZ_PKESZ(_x) FIELD_PREP(LTC0_PKESZ_PKESZ_MASK, _x)

/* LTC0_FIFOSTA */

#define LTC0_FIFOSTA_OFF BIT(31)

#define LTC0_FIFOSTA_OFL_MASK GENMASK(22, 16)
#define LTC0_FIFOSTA_OFL(_x) FIELD_PREP(LTC0_FIFOSTA_OFL_MASK, _x)

#define LTC0_FIFOSTA_IFF BIT(15)

#define LTC0_FIFOSTA_IFL_MASK GENMASK(6, 0)
#define LTC0_FIFOSTA_IFL(_x) FIELD_PREP(LTC0_FIFOSTA_IFL_MASK, _x)
